...
func (app *AddPeopleApplication) checkAccess(me *people.Person, room *rooms.Room, membership memberships.Membership) bool {
	if app.Access == "a" {
		return true
...
func (app *AddPeopleApplication) processAddPeople(room *rooms.Room) error {
